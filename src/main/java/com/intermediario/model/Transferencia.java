...
import com.intermediario.model.converter.TipoTransferenciaConverter;
...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "transferencias", indexes = @Index(name = "idx_transferencias_numero_ordem", columnList = "numero_ordem"))
...
public class Transferencia {
	...
	@ManyToOne
	@JsonIgnore
	@JoinColumn(name = "historico_bancario_id", referencedColumnName = "id", nullable = false, foreignKey = @ForeignKey(name = "fk_transferencias_hitoricos_bancarios"))
