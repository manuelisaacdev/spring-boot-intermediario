...
@Table(name = "levantamentos", indexes = @Index(name = "idx_levantamentos_numero_ordem", columnList = "numero_ordem"))
public class Levantamento {
	...
	@ManyToOne
	@JsonIgnore
	@JoinColumn(name = "historico_bancario_id", referencedColumnName = "id", nullable = false, foreignKey = @ForeignKey(name = "fk_levantamentos_hitoricos_bancarios"))
